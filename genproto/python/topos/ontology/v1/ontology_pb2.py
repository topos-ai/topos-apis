...
_ONTOLOGY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\030\"\017/v1/brands/bulk:\005names'),
  ),
  _descriptor.MethodDescriptor(
    name='ListBrands',
