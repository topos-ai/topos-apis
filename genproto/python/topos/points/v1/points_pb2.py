...
_POINTS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\022*\020/v1/brands:count'),
  ),
  _descriptor.MethodDescriptor(
