...
_POINTS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SetRegionScore',
    full_name='topos.points.v1.Points.SetRegionScore',
    index=16,
    containing_service=None,
