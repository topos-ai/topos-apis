...
_POINTS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002a\"K/v1/{region_score.name=brands/*/regionScores/*/regionTypes/*/regions/*}:set:\022brand_region_score'),
  ),
])
