...
_GETREGIONGEOMETRYREQUEST.fields_by_name['geometry_encoding'].enum_type = _GEOMETRYENCODING
...
_LOCATIONS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0020\"+/v1/{name=regionTypes/*/regions/*}/geometry:\001*'),
  ),
  _descriptor.MethodDescriptor(
