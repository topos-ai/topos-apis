...
_TIMESERIES = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\033\"\024/v1/bulk/average:set:\003bin'),
  ),
  _descriptor.MethodDescriptor(
