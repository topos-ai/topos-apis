...
type GetRegionGeometryRequest struct {
	...
	GeometryEncoding     GeometryEncoding `protobuf:"varint,2,opt,name=geometry_encoding,json=geometryEncoding,proto3,enum=topos.locations.v1.GeometryEncoding" json:"geometry_encoding,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *GetRegionGeometryRequest) GetGeometryEncoding() GeometryEncoding {
	if m != nil {
...
var fileDescriptor_954338d7542bc8de = []byte{
	...
	,
}
